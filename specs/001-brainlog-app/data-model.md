...
This document defines the data model for BrainLog, mapping functional requirements from [spec.md](spec.md) to WatermelonDB table schemas. All entities sync with Firebase Realtime Database using a custom sync adapter.
