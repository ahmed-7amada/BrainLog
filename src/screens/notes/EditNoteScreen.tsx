...
type Props = NotesScreenProps<'EditNote'>;

const EditNoteScreen: React.FC<Props> = () => {
  const navigation = useNavigation<Props['navigation']>();
  const route = useRoute<Props['route']>();
  const { noteId } = route.params;
  const { notes, updateNote, deleteNote, getAllFolders } = useNotes();
